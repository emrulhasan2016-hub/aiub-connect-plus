...
renderItem={({ item }) => (
  <JobCard
job={item}
 onPress={() => navigation.navigate(routes.JOB_DETAILS, { jobId: item.id })}
/>
)}
...
searchContainer: { flexDirection: "row", alignItems: "center", backgroundColor: colors.white, borderRadius: sizes.radiusSm, paddingHorizontal: spacing.md, height: 42, marginBottom: spacing.md },
 ...
 typeChip: { paddingHorizontal: spacing.md, paddingVertical: spacing.xs, backgroundColor: colors.white, borderRadius: sizes.radiusSm, marginRight: spacing.sm, height: 32, justifyContent: "center" },
activeTypeChip: { backgroundColor: colors.goldDark },
typeText: { color: colors.muted, fontSize: fonts.size.sm, fontWeight: fonts.weight.medium },
