...
{!isMe && <Text style={styles.senderName}>{sender ? sender.fullName : "User"}</Text>}
<View style={[styles.bubble, isMe ? styles.bubbleMe : styles.bubbleOther]}>
 <Text style={[styles.msgText, isMe && styles.textMe]}>{item.text}</Text>
 </View>
...
msgText: { fontSize: fonts.size.base, color: colors.text },
 ...
 time: { fontSize: fonts.size.xs, color: colors.muted, marginTop: 2, alignSelf: "flex-end" },
 inputContainer: { flexDirection: "row", padding: spacing.md, backgroundColor: colors.white, alignItems: "center", gap: spacing.sm },
 input: { flex: 1, backgroundColor: colors.gray100, height: 42, borderRadius: sizes.radiusSm, paddingHorizontal: spacing.md },  sendBtn: { width: 42, height: 42, borderRadius: 21, backgroundColor: colors.navy, justifyContent: "center", alignItems: "center" },
});