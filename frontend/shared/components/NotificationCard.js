...
const typeIcon = { Like: "heart", Comment: "chatbubble", Reply: "arrow-undo", Group: "people", Notice: "megaphone", Job: "briefcase" };
const typeColor = { Like: colors.danger, Comment: colors.navy, Reply: colors.alumni, Group: colors.faculty, Notice: colors.gold, Job: colors.success };
...
const styles = StyleSheet.create({
  card: { flexDirection: "row", alignItems: "center", backgroundColor: colors.white, borderRadius: 16, padding: 13, marginBottom: 8 },
