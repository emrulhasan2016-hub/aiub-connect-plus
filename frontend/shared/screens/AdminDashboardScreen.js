            ...
            {/*quick stats section */}
                ...
                <View style={styles.actionsContainer}>
                    ...
                    onPress={() => navigation.navigate('UserManagement')} >
                        <Text style={styles.buttonText}>Manage Users and Roles</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                    style={styles.Button , styles.secondaryButton}
                    onPress={() => alert('System logs feature coming soon!')} 
                    >
                        <Text style={styles.buttonText}>View System Logs</Text>
                    </TouchableOpacity>
                </View>
        </ScrollView>
    );
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 24, fontWeight: 'bold', marginVertical: 15, color: '#333' },
  statsContainer: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 },
  card: { flex: 1, padding: 20, borderRadius: 10, marginHorizontal: 5, alignItems: 'center' },
  ...
  button: { backgroundColor: '#003366', padding: 15, borderRadius: 8, alignItems: 'center', marginBottom: 12 },
