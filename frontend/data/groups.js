...
const groups = [
  {
    id: "g1",
    name: "AIUB CSE",
    description: "Official group for Computer Science & Engineering students and faculty.",
    category: "Department",
    cover: covers[0],
  ...
  },
  {
    ...
    description: "Connecting future business leaders of AIUB through events and workshops.",
    category: "Club",
    cover: covers[1],
    memberIds: ["u2", "u4"],
    messages: [
  ...
  {
    id: "g3",
    name: "Thesis Group - Mobile Computing",
    description: "Collaboration space for thesis students working on mobile computing topics.",
    category: "Academic",
    cover: covers[2],
    memberIds: ["u1"],
    messages: [],
  },
  {
    ...
    description: "Weekly problem solving sessions, contests, and coding discussions.",
    category: "Club",
    cover: covers[0],
    memberIds: ["u1", "u6"],
    messages: [
