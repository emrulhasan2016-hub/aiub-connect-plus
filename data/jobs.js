...
const jobs = [
  {
    ...
    description:
      "Looking for a junior mobile developer with basic React Native and Expo experience. Fresh graduates welcome.",
    requirements: ["React Native basics", "Git", "Good communication"],
    deadline: "2026-08-01",
    applyLink: "https://example.com/apply/finzo-rn",
  },
  {
    id: "j2",
    userId: "u4",
    ...
    description:
      "3-month paid internship for undergraduate CSE students, working on real client projects.",
    requirements: ["JavaScript", "React basics"],
    deadline: "2026-07-25",
    applyLink: "https://example.com/apply/codenest-intern",
  },
  {
    id: "j3",
    userId: "u3",
    type: "Scholarship",
    company: "AIUB Merit Scholarship Fund",
    position: "Merit-based Tuition Scholarship",
